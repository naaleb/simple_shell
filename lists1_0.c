...
/**
 * list_len – Funct to determine length of linked list
...
/**
 * list_to_strings – Funct. to returns an array of strings of the list->str
 ...
 * @node: A pointer to the head of list
...
/**
 * get_node_index -Funct to get the index of a node
