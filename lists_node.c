...
/**
 * add_node_end – Funct to add a node to the end of the list
...
/**
 * print_list_str - Print only string element of a list_t linked list
...
/**
 * free_list – Funct to free all nodes of a list
